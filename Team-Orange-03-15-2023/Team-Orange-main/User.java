...
public class User {
     ...
     * Author Gregory Yi, JD
     */
    public String export(String theFile, User user) {
        ...
        try {
            ...
            if (myObj.createNewFile()) {
                ...
                return "Failed to write to file due to " + "File already exists.";
            }
        } catch (IOException e) {
        ...
        try {
            ...
            System.out.println("An error occurred.");
            e.printStackTrace();
            return "Failed to write to file due to " + e;
        }
        return "Successfully wrote to file + " + theFile;
    }
